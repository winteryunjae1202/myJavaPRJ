...
public class Ex09_09 {
    public static void main(String[] args) {
        ...
        System.out.println("문자열==문자열2 결과 : \t " + (str1==str2));
        System.out.println("문자열1.eqauls(문자열2) 결과 : " + str1.equals(str2));
        System.out.println("문자열1==문자열3 결과 : \t" + (str1 == str3));
        System.out.println("문자열1.eqauls(문자열3) 결과 : " + str1.equals(str3));
